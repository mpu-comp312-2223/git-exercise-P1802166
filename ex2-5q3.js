  ...
  modules: [
    {
      ...
      lectures: [
        { dow: 1, start: 1130, end: 1300, room: 'N_53' },
        { dow: 4, start: 1000, end: 1130, room: 'N_54' }
      ]
    },
    {
      code: 'comp313', title: 'PROJECT MANAGEMENT', year: 3,
      lectures: [
        { dow: 1, start: 1430, end: 1600, room: 'N_53' },
        { dow: 4, start: 1130, end: 1300, room: 'N_53' }
      ]
    },
    {
      code: 'MENG311', title: 'ENGLISH V', year: 3,
      lectures: [
        { dow: 3, start: 1430, end: 1730, room: 'N_53' },
        { dow: 4, start: 1430, end: 1600, room: 'A207' }
      ]
    }
  ]
};